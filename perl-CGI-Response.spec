...
CGI::Response jest modułem Perla do konstruowania odpowiedzi na zapytania
przez Common Gateway Interface (CGI).  Jest zaprojektowany tak, aby być
lekkim i efektywnym w większości popularnych zadań, a także umożliwić
dostęp do wszystkicy cech odpowiedzi HTTP bardziej zaawansowanym
aplikacjom CGI.
